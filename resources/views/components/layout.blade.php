        ...
        <div class="mt-8 md:mt-0 flex items-center">
            @auth
                <x-dropdown>
                    ...
                    <x-dropdown-item href="#" x-data="{}" @click.prevent="document.querySelector('#form-logout').submit()">Log Out</x-dropdown-item>

                      <form id="form-logout" action="/logout" method="POST" class="hidden">
                         @csrf
